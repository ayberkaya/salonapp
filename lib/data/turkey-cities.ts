...
export const turkeyCities: Record<string, string[]> = {
  'Adana': ['Seyhan', 'Yüreğir', 'Çukurova', 'Sarıçam', 'Karaisalı', 'Pozantı', 'Karatas', 'Kozan', 'Ceyhan', 'İmamoğlu', 'Feke', 'Saimbeyli', 'Tufanbeyli', 'Aladağ'],
  ...
  'Antalya': ['Alanya', 'Elmalı', 'Finike', 'Gazipaşa', 'Gündoğmuş', 'Kaş', 'Kemer', 'Korkuteli', 'Kumluca', 'Manavgat', 'Serik', 'Akseki', 'Aksu', 'Döşemealtı', 'İbradı', 'Konyaaltı', 'Muratpaşa', 'Kepez'],
  ...
  'Bursa': ['Osmangazi', 'Nilüfer', 'Mudanya', 'Gemlik', 'Orhangazi', 'İnegöl', 'Yıldırım', 'Mustafakemalpaşa', 'Karacabey', 'Marmaraereğlisi', 'Orhaneli', 'Büyükorhan', 'Harmancık', 'Keles', 'Gürsu', 'Kestel'],
  ...
  'Denizli': ['Merkez', 'Acıpayam', 'Babadağ', 'Baklan', 'Bekilli', 'Beyağaç', 'Bozkurt', 'Buldan', 'Çal', 'Çameli', 'Çardak', 'Çivril', 'Güney', 'Honaz', 'Kale', 'Sarayköy', 'Serinhisar', 'Tavas', 'Pamukkale'],
  ...
  'İzmir': ['Aliağa', 'Bayındır', 'Bergama', 'Beydağ', 'Bornova', 'Buca', 'Çeşme', 'Çiğli', 'Dikili', 'Foça', 'Gaziemir', 'Güzelbahçe', 'Karabağlar', 'Karaburun', 'Karşıyaka', 'Kemalpaşa', 'Kınık', 'Kiraz', 'Konak', 'Menderes', 'Menemen', 'Narlıdere', 'Ödemiş', 'Seferihisar', 'Selçuk', 'Tire', 'Torbalı', 'Urla'],
  ...
  'Kocaeli': ['Gebze', 'Gölcük', 'Kandıra', 'Karamürsel', 'Kartepe', 'Körfez', 'Derince', 'Başiskele', 'Çayırova', 'Dilovası', 'İzmit', 'Karamürsel'],
  'Konya': ['Meram', 'Karatay', 'Selçuklu', 'Akşehir', 'Beyşehir', 'Bozkır', 'Cihanbeyli', 'Çeltik', 'Çumra', 'Derbent', 'Derebucak', 'Doğanhisar', 'Emirgazi', 'Ereğli', 'Güneysinir', 'Hadim', 'Halkapınar', 'Hüyük', 'Ilgın', 'Kadınhanı', 'Karapınar', 'Kulu', 'Sarayönü', 'Seydişehir', 'Taşkent', 'Tuzlukçu', 'Yalıhüyük', 'Yunak', 'Altınekin', 'Çatalhöyük', 'Derbent', 'Derebucak'],
  ...
  'Van': ['İpekyolu', 'Tuşba', 'Bahçesaray', 'Başkale', 'Çaldıran', 'Çatak', 'Edremit', 'Erciş', 'Gevaş', 'Gürpınar', 'Muradiye', 'Özalp', 'Saray'],
...
export const turkeyProvinces = Object.keys(turkeyCities).sort()
